...
const AboutMe = () => {
    const name = ["Alfian Agung Prasetyo", "08129221039", "alfianagung2000@gmail.com"];
    ...
    <Container>
      <div className="row py-5" >
        ...
        <div className="col-lg-5 px-5">
          ...
          <h4 className="pt-2">Name : {name[0]}</h4>
          <h4 className="pt-4">Phone : {name[1]}</h4>
          <h4 className="pt-4">Email : {name[2]}</h4>
